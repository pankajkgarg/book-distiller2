...
- The **aim** number is your target; the range is the acceptable band. Treat the top of the range as a hard editorial ceiling: never exceed it, no matter how relevant the material feels.
...
4. Assign each section a word budget that sums to the aim. Draft against that coverage ledger, giving each item only the space its role justifies.
...
6. Silently verify that every source section is represented, the total is within budget, and all quotations remain exact.
